...
import kotlinx.android.synthetic.main.fragment_update_saving_goal.*
...
class UpdateSavingGoalFragment : BaseFragment() {
    ...
    private fun initControls() {
        saving?.let { sav ->
            ...
            categoryViewModel.getCategory(sav.idCategory).observe(viewLifecycleOwner, Observer {
                ...
                txt_title_category_update_saving.text = it.title
            })
    ...
    private fun saveSavingGoal() {
        ...
        when {
            ...
            txt_title_category_update_saving.text.toString().trim().isEmpty() -> {
    ...
    override fun getLayoutId(): Int {
        return R.layout.fragment_update_saving_goal
    }
