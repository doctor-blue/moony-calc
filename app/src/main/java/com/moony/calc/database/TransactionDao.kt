...
interface TransactionDao {
    ...
    @Query("select transaction_table.*, category_table.* from transaction_table inner join category_table on transaction_table.idCategory = category_table.idCategory where  strftime('%Y', transactionTime) = :year and strftime('%M', transactionTime) = :month")
